...
var Engine = (function(global) {
    ...
    function render() {
        ...
        ctx.fillText("High Score: " + localStorage.highscore, 500, 64);
        if (state == "start") {
            renderPlayerSelect();
    ...
    function renderPlayerSelect() {
        ...
        ctx.textBaseline = "top";
        ctx.fillText("Select your player",350, 475);
    }
    function renderGameOver() {
        ...
        ctx.fillText('Press "Enter" to play again',350, 435);
        ctx.fillText('Press "Space" to select a new character',350, 470);
    }
